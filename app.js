...
//returned code to working state, arrow fnc not suitable as constructor
...
//Returned code to working state, arrow function caused this.name to refer to nothing 
...
//    the value of this the Student object 'joe'
// 2. What is "this" when joe.scopeArrow() is invoked?
//    the value of this is the window obj
// 3. Explain why "this" is different when an arrow function is used.
/*    in a normal function, 'this' refers to the direct execution context of the fnc. For 
      an arrow fnc 'this' refers to what surrounds the fnc that encloses 'this'.
      Here the window obj surrounds the calls to the prototype methods and the
      direct execution context of the 'this' in the normal fnc is the 'joe' Student obj */
